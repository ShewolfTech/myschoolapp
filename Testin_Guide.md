...
A few things aren't built yet (in-app inquiry messaging, photos) — those are
coming in later steps. For now, please focus on whether the flows below feel
clear and useful.
...
Browsing and searching **never requires an account** — that's intentional,
since most parents will just want to look schools up quickly. An account is
only needed if you want to save schools to check again later.

### Searching (no account needed)
...
### Saving schools (optional account)
1. On any school's detail page, click **"Save school"**.
2. You'll be asked to log in or sign up first — go ahead and create a
   parent account.
3. Once logged in, saving a school should work right away — the button
   fills in and says "Saved."
4. Click **"Saved schools"** in the top navigation to see everything
   you've bookmarked.
5. Try saving 2–3 schools from different regions, then unsaving one.
...
yet? Is "saving" schools useful, or would you rather compare them some other
way?
...
4. Fill out the registration form:
   ...
   - Add contact info
5. Submit. You'll see a **"pending"** status — this is normal. It won't
   show up in public search yet.
...
|---|---|---|
| Parent | No login needed to search; optional signup to save schools | |
